(function() {
    ...
    describe('Subtitle.Parser.SubRip.parse function', {
        ...
        before_all: function() {
            initial_prototype = {
                initialize_parser: MooPlay.Subtitle.Parser.SubRip.prototype.initialize,
                initialize_item: MooPlay.Subtitle.Item.prototype.initialize
            };
        },
        
        after_all: function() {
            MooPlay.Subtitle.Parser.SubRip.prototype.initialize = initial_prototype.initialize_parser;
        ...
        before_each: function() {
            ...
            MooPlay.Subtitle.Parser.SubRip.prototype.initialize = $empty;
